...
- Unreleased (S2): Composite / non-`:id` primary keys in update/destroy. `:binary`/AshCloak round-trip via base64. Error-message value redaction (operator/field + SQLSTATE only).
